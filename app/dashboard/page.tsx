      ...
      <div className="relative z-10 container mx-auto p-8 pb-20 min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row gap-8 h-[calc(100vh-250px)]">
          <div className="flex-1 space-y-4">
            ...
            <div className="flex h-[60%] rounded-lg bg-[#1a1a1a] border border-[#00ffb3]/30 overflow-hidden font-mono text-sm">
              {/* Line numbers */}
            ...
            <textarea
              className="w-full h-[20%] p-4 rounded-lg bg-[#1a1a1a] border border-[#00ffb3]/30 focus:border-[#00ffb3] focus:ring-2 focus:ring-[#00ffb3]/40 text-white"
              value={inputData}
          ...
          <div className="flex-1 space-y-4">
            ...
            <pre className="h-[calc(100%-40px)] bg-[#1a1a1a] p-6 rounded-lg border border-[#00ffb3]/30 text-white text-sm overflow-auto">
              {output || "Output will appear here..."}
            </pre>
          </div>
        </div>

        <footer className="absolute bottom-0 left-0 right-0 p-6 flex gap-6 items-center justify-center border-t border-[#00ffb3]/20 text-[#00ffb3]">
          <a
